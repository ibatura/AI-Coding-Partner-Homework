...
1. **Discover the codebase** — explore the project structure, tech stack, and how LLM/GenAI capabilities are integrated (API calls, prompt construction, RAG pipelines, agent frameworks, vector stores, etc.).
