...
Build a **4-agent pipeline**: Bug Research Verifier, Bug Implementer, 
Security Vulnerabilities Verifier, Unit Test Generator (all required). Provide the **application with all 4 agents**, **screenshots**, **all fixes applied**, and **unit tests generated by the agents**.
